...
class ProductCharacteristics(models.Model):
    ...
    collection = fields.Char(
        string="Collection",
        help=("Indicate the product's collection name "
                "e.g., Summer 2024, Classic Line"
            )
    )

    weight_label = fields.Char(
        string="Weight Label",
        help=("Specify the label or code related to "
    ...
    color = fields.Char(
        string="Color",
        help=("Provide a descriptive name for the product's "
    ...
    material_code = fields.Char(
        ...
        help=("Enter the internal or external code for "
    ...
    raw_size = fields.Char(
        string="Raw Size",
        help=("Indicate the dimensions or size of the product "
